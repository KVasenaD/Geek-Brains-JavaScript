...
Vue.component('cart', {
    ...
    template: `<div>
<button class="btn-cart" type="button" @click="showCart = !showCart"><img src="icons/basket.png" alt="Корзина"></button>
    ...
    <div class="cart-item">
                    <div class="product-bio">
                        ...
                        <div class="product-desc">
                            ...
                            <div class="product-single-price">Цена: {{ cartItem.price }} рублей</div>
                        </div>
                    </div>
